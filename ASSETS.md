...
The store screenshots in `docs/store/` show synthetic content from
`docs/store/preview.html`, not a real mailbox or spreadsheet. Do not replace them
...
it does not bundle Chromium. The review found no evidence of copied Chromium
source. If code is copied later, retain the applicable upstream license/notices.
Gmail, Google, Safari, and Apple names identify compatibility and belong to their
respective owners. The project is not affiliated with Google or Apple.
